...
public final class ExcavateHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        try {
            ...
            Excavate.Outcome outcome = Excavate.run(
                    req.x1, req.y1, req.z1, req.x2, req.y2, req.z2, req.timeoutSeconds);
    ...
    private static Map<String, Object> toBody(Excavate.Outcome outcome) {
        Map<String, Object> body = new LinkedHashMap<>();
        int[] b = outcome.box();
        if (outcome instanceof Excavate.Cleared c) {
            body.put("success", true);
            body.put("reason", c.reason());
            body.put("box", List.of(b[0], b[1], b[2], b[3], b[4], b[5]));
            body.put("volume", c.volume());
            body.put("remaining", c.remaining());
            body.put("message", c.message());
        } else if (outcome instanceof Excavate.Failed f) {
    ...
    private record Request(int x1, int y1, int z1, int x2, int y2, int z2, long timeoutSeconds) {}
    ...
    private static Request parseBody(HttpExchange exchange) throws IOException {
        ...
        long timeoutSec = Excavate.DEFAULT_TIMEOUT_SECONDS;
        ...
        return new Request(x1, y1, z1, x2, y2, z2, timeoutSec);
    }
